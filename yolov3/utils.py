...
def bboxes_iou(boxes1, boxes2):
    """
        ...
        :param boxes1: first box, list object with coordinates (x1, y1, x2, y2)
        :param boxes2: second box, list object with coordinates (x1, y1, x2, y2)
...
def nms(bboxes, iou_threshold, sigma=0.3, method='nms'):
    ...
    :param iou_threshold:
    :param sigma:
    :param method: which method to do
    :return:
    """
